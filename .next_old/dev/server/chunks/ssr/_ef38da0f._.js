...
"[project]/lib/actions/auth-helpers.ts [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function verifyMembership() {
    ...
    const { data: membership, error: membershipError } = await supabase.from('memberships').select('organization_id, role, branch_id').eq('user_id', user.id).eq('is_active', true).maybeSingle();
...
async function getServerOrgId(supabase) {
    const { data: orgId } = await supabase.rpc('get_my_org_id');
    if (!orgId) {
        throw new Error('Sin organización activa');
    }
...
"[project]/types/supabase-joins.ts [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
 ...
 *
 * ═══════════════════════════════════════════════════════════════════════════════
 */ /* __next_internal_action_entry_do_not_use__ [{"40d029fc6c95ed9534fed10662ea7633d49df97d3b":"getInventoryCriticalAction","40f9514d7f3e486894a69a1ee200cf46d4b6cfc67e":"getQuickSnapshotAction","60c5cea36833a9991afc4b9158361001006a7382bd":"getDailySalesChartAction","78fefa28db228ef2be5fad91633ef642e7e4cad836":"getOwnerStatsAction"},"",""] */ __turbopack_context__.s([
    ...
    "getOwnerStatsAction",
    ()=>getOwnerStatsAction,
    "getQuickSnapshotAction",
    ()=>getQuickSnapshotAction
]);
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/build/webpack/loaders/next-flight-loader/server-reference.js [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$actions$2f$auth$2d$helpers$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/actions/auth-helpers.ts [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$types$2f$supabase$2d$joins$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/types/supabase-joins.ts [app-rsc] (ecmascript)");
...
async function getOwnerStatsAction(branchId, dateFrom, dateTo, costRatio = DEFAULT_COST_RATIO) {
    try {
        const { supabase } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$actions$2f$auth$2d$helpers$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["verifyAuth"])();
        // Validaciones
        if (!branchId) {
        ...
        let salesQuery = supabase.from('sales').select('id').eq('branch_id', branchId);
        ...
        let topData = null;
        if (saleIds.length > 0) {
            const { data } = await supabase.from('sale_items').select('quantity, products(name, emoji)').in('sale_id', saleIds);
            topData = data;
        }
        const productCounts = {};
        (topData || []).forEach((item)=>{
            const product = (0, __TURBOPACK__imported__module__$5b$project$5d2f$types$2f$supabase$2d$joins$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["resolveJoin"])(item.products);
...
async function getQuickSnapshotAction(organizationId) {
    ...
    try {
        ...
        if (!organizationId) {
            return {
                ...
                error: 'Org no especificada'
            };
        }
        const today = new Date().toISOString().split('T')[0];
        // Ventas de hoy (todas las sucursales de la org)
        const { data: salesData } = await supabase.from('v_daily_sales').select('total_amount, sale_count').eq('date', today);
        let ventasHoy = 0;
        let cantVentas = 0;
        (salesData || []).forEach((row)=>{
        ...
        const { data: lowStockData } = await supabase.from('v_products_with_stock').select('id, stock_available, min_stock').eq('is_active', true).eq('is_service', false);
...
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerServerReference"])(getOwnerStatsAction, "78fefa28db228ef2be5fad91633ef642e7e4cad836", null);
...
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerServerReference"])(getQuickSnapshotAction, "40f9514d7f3e486894a69a1ee200cf46d4b6cfc67e", null);
}),
...
async function getAttendanceStatusAction(sucursalId) {
    try {
        ...
        const { data, error } = await supabase.from('attendance').select('id, organization_id, branch_id, user_id, check_in, check_out, created_at').eq('user_id', user.id).eq('branch_id', sucursalId).is('check_out', null).maybeSingle();
        if (error) {
            return {
                success: false,
                activeRecord: null,
...
async function toggleAttendanceAction(sucursalId) {
    try {
        ...
        const { data: fichajeActivo } = await supabase.from('attendance').select('id, organization_id, branch_id, user_id, check_in, check_out, created_at').eq('user_id', user.id).eq('branch_id', sucursalId).is('check_out', null).maybeSingle();
        ...
        if (!fichajeActivo) {
            ...
            }).select('id, organization_id, branch_id, user_id, check_in, check_out, created_at').single();
            if (error) {
                return {
                    success: false,
                    action: null,
...
async function processQRScanAction(qrData, sucursalId) {
    try {
        ...
        if (qrData.tipo === 'entrada') {
            ...
            const { data: fichajeActivo } = await supabase.from('attendance').select('id').eq('user_id', user.id).eq('branch_id', qrData.sucursal_id).is('check_out', null).maybeSingle();
            if (fichajeActivo) {
                return {
                    success: false,
                    action: null,
        ...
        if (qrData.tipo === 'salida') {
            const { data: asistenciaActual } = await supabase.from('attendance').select('id').eq('user_id', user.id).eq('branch_id', qrData.sucursal_id).is('check_out', null).maybeSingle();
            if (!asistenciaActual) {
                return {
                    success: false,
                    action: null,
...
async function getStaffManagementDataAction() {
    try {
        ...
        const invites = (invitesRaw || []).map((inv)=>{
            const branch = (0, __TURBOPACK__imported__module__$5b$project$5d2f$types$2f$supabase$2d$joins$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["resolveJoin"])(inv.branches);
            return {
                id: inv.id,
                email: inv.email,
        ...
        const employees = (membersRaw || []).map((m)=>{
            const branch = (0, __TURBOPACK__imported__module__$5b$project$5d2f$types$2f$supabase$2d$joins$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["resolveJoin"])(m.branches);
            return {
                id: m.user_id,
...
async function inviteEmployeeAction(email, branchId) {
    try {
        ...
        const { supabase, user, orgId } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$actions$2f$auth$2d$helpers$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["verifyOwner"])();
...
async function cancelInviteAction(inviteId) {
    try {
        const { supabase, orgId } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$actions$2f$auth$2d$helpers$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["verifyOwner"])();
        if (!inviteId) {
            return {
                success: false,
        ...
        const { error } = await supabase.from('pending_invites').delete().eq('id', inviteId).eq('organization_id', orgId);
        if (error) {
            return {
                success: false,
...
async function completeProfileSetupAction(formData) {
    try {
        ...
        const supabaseAuth = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2d$server$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["createClient"])();
...
async function getBranchesWithQRAction() {
    try {
        ...
        const { data: branchesData, error } = await supabase.from('branches').select('id, name, qr_entry_url, qr_exit_url').eq('organization_id', orgId).eq('is_active', true).order('name');
        if (error) {
            return {
                success: false,
                branches: [],
...
async function updateBranchQRAction(sucursalId, tipo, qrUrl) {
    try {
        ...
        const { error } = await supabase.from('branches').update(updateData).eq('id', sucursalId).eq('organization_id', orgId);
        if (error) {
            return {
                success: false,
...
async function getBranchesAction() {
    try {
        ...
        // Schema V2: Usar tabla branches
        const { data, error } = await supabase.from('branches').select('id, name, address, organization_id, created_at').eq('organization_id', orgId).eq('is_active', true).order('created_at', {
            ascending: true
        });
        if (error) {
            return {
...
async function createBranchAction(data) {
    try {
        ...
        const { data: nuevaBranch, error } = await supabase.from('branches').insert({
            organization_id: orgId,
            name: data.nombre,
...
async function deleteBranchAction(branchId) {
    try {
        ...
        const { error } = await supabase.from('branches').update({
            is_active: false
        }).eq('id', branchId).eq('organization_id', orgId);
        if (error) {
            return {
                success: false,
...
async function checkExistingProductAction(barcode) {
    try {
        const { supabase, orgId } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$actions$2f$auth$2d$helpers$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["verifyAuth"])();
        // ───────────────────────────────────────────────────────────────────────────
        // Buscar producto existente
        // ───────────────────────────────────────────────────────────────────────────
        const { data: existente, error } = await supabase.from('products').select('name').eq('barcode', barcode).eq('organization_id', orgId).maybeSingle();
        if (error) {
            return {
                success: false,
                exists: false,
...
async function createFullProductAction(formData, sucursalId) {
    try {
        ...
        // ───────────────────────────────────────────────────────────────────────────
        const { data: nuevoProducto, error: errorProd } = await supabase.from('products').insert([
            {
                organization_id: orgId,
        ...
        // ───────────────────────────────────────────────────────────────────────────
        const { error: errorHistorial } = await supabase.from('price_history').insert({
            organization_id: orgId,
        ...
        if (formData.cantidad_inicial > 0) {
            const { error: errorStock } = await supabase.from('stock_batches').insert({
                organization_id: orgId,
                branch_id: sucursalId,
                product_id: nuevoProducto.id,
...
async function applyHappyHourDiscountAction(productoId) {
    try {
        ...
        const { supabase, user, orgId } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$actions$2f$auth$2d$helpers$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["verifyAuth"])();
        // ───────────────────────────────────────────────────────────────────────────
        // PASO 2: Obtener precio actual del producto
        // ───────────────────────────────────────────────────────────────────────────
        const { data: producto, error: fetchError } = await supabase.from('products').select('sale_price, name, cost').eq('id', productoId).eq('organization_id', orgId).single();
        if (fetchError) {
            return {
                success: false,
        ...
        // ───────────────────────────────────────────────────────────────────────────
        const { error: historialError } = await supabase.from('price_history').insert({
            organization_id: orgId,
...
async function updateProductAction(productId, data) {
    try {
        ...
        // ───────────────────────────────────────────────────────────────────────────
        const { data: oldProduct, error: fetchError } = await supabase.from('products').select('sale_price, cost').eq('id', productId).eq('organization_id', orgId).single();
        if (fetchError) {
            return {
                success: false,
                error: `Error al obtener producto: ${fetchError.message}`
...
async function deleteProductAction(productId) {
    try {
        ...
        // ───────────────────────────────────────────────────────────────────────────
        const { error: deleteError } = await supabase.from('products').delete().eq('id', productId).eq('organization_id', orgId);
        if (deleteError) {
            return {
                success: false,
...
async function rechargeBalanceAction(providerId, monto) {
    try {
        const { supabase } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$actions$2f$auth$2d$helpers$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["verifyOwner"])();
        // ───────────────────────────────────────────────────────────────────────────
        // VALIDACIONES
        // ───────────────────────────────────────────────────────────────────────────
        if (!providerId) {
...
async function getProvidersAction(_organizationId, sucursalId) {
    try {
        const { supabase, orgId: organizationId } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$actions$2f$auth$2d$helpers$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["verifyAuth"])();
        // ───────────────────────────────────────────────────────────────────────────
...
"[project]/lib/actions/reports.actions.ts [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";

/* __next_internal_action_entry_do_not_use__ [{"40878cd0ad1bdc5adbcebb35ed0494afa56ccb52ce":"getCashRegisterReportAction","40ce712cd546b72610d5dbdcd104688d7aff60a476":"getStockReportAction","60fdd35c71699cd623fa6469c2c8ced0d7fc735b42":"getExpiringProductsReportAction","704bd179d789321c61f1ffc814274d3ee114d8014c":"getCashRegistersListAction","705cf0da7b5e9845b1d65d4cf79b38ea2b9d2963b2":"getSalesReportAction"},"",""] */ __turbopack_context__.s([
...
async function getSalesReportAction(branchId, fromDate, toDate) {
    try {
      ...
      `).eq("branch_id", branchId).gte("created_at", fromDate).lte("created_at", toDate).order("created_at", {
            ascending: false
        });
        if (salesError) {
            return {
        ...
        const sales = (salesData || []).map((s)=>{
            ...
            const cashReg = (0, __TURBOPACK__imported__module__$5b$project$5d2f$types$2f$supabase$2d$joins$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["resolveJoin"])(s.cash_registers);
            const membership = (0, __TURBOPACK__imported__module__$5b$project$5d2f$types$2f$supabase$2d$joins$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["resolveJoin"])(cashReg?.memberships);
            return {
                id: s.id,
                date: s.created_at,
                total: s.total || 0,
                paymentMethod: s.payment_method || "unknown",
                itemCount: items?.reduce((sum, i)=>sum + (i.quantity || 0), 0) || 0,
...
async function getCashRegisterReportAction(cashRegisterId) {
    try {
        // Verificar permisos de acceso a reportes
        const access = await verifyReportAccess();
        if (!access.authorized || !access.supabase) {
        ...
        const supabase = access.supabase;
        // Obtener caja
        const { data: registerData, error: registerError } = await supabase.from("cash_registers").select(`
        id,
        date,
        opened_at,
        closed_at,
      ...
      `).eq("id", cashRegisterId).single();
        if (registerError || !registerData) {
            return {
                success: false,
                error: registerError?.message || "Caja no encontrada"
            };
        }
        // Obtener movimientos
        const { data: movementsData } = await supabase.from("cash_movements").select("id, type, amount, category, description, created_at").eq("cash_register_id", cashRegisterId).order("created_at", {
            ascending: true
        });
        // Obtener ventas de la caja
        const { data: salesData } = await supabase.from("sales").select("total, payment_method").eq("cash_register_id", cashRegisterId);
        ...
        const expectedAmount = (registerData.opening_amount || 0) + salesSummary.cash + totalIngresos - totalEgresos;
        const membership = (0, __TURBOPACK__imported__module__$5b$project$5d2f$types$2f$supabase$2d$joins$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["resolveJoin"])(registerData.memberships);
        return {
            success: true,
            data: {
                register: {
                ...
                summary: {
                    ...
                    variance: registerData.closing_amount !== null ? registerData.closing_amount - expectedAmount : null
                }
            }
        };
    } catch (error) {
...
async function getStockReportAction(branchId) {
    try {
        // Verificar permisos de acceso a reportes
        const access = await verifyReportAccess();
        if (!access.authorized || !access.supabase) {
        ...
        const { data: productsData, error: productsError } = await supabase.from("v_products_with_stock").select("*").eq("branch_id", branchId).eq("is_active", true).order("name");
        if (productsError) {
            return {
                success: false,
...
async function getExpiringProductsReportAction(branchId, daysAhead = 15) {
    try {
        // Verificar permisos de acceso a reportes
        const access = await verifyReportAccess();
        if (!access.authorized || !access.supabase) {
        ...
        const { data: batchesData, error: batchesError } = await supabase.from("stock_batches").select(`
        id,
        quantity,
        cost_per_unit,
        expiration_date,
        products(name)
      `).eq("branch_id", branchId).gt("quantity", 0).not("expiration_date", "is", null).lte("expiration_date", futureDate.toISOString().split("T")[0]).order("expiration_date", {
            ascending: true
        });
        if (batchesError) {
            return {
        ...
        const products = (batchesData || []).map((b)=>{
            const product = (0, __TURBOPACK__imported__module__$5b$project$5d2f$types$2f$supabase$2d$joins$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["resolveJoin"])(b.products);
...
async function getCashRegistersListAction(branchId, fromDate, toDate) {
    try {
        // Verificar permisos de acceso a reportes
        const access = await verifyReportAccess();
        if (!access.authorized || !access.supabase) {
        ...
        const supabase = access.supabase;
        const { data, error } = await supabase.from("cash_registers").select("id, date, closed_at, memberships(display_name)").eq("branch_id", branchId).gte("date", fromDate).lte("date", toDate).order("date", {
            ascending: false
        });
        if (error) {
            return {
        ...
        const registers = (data || []).map((r)=>{
            const membership = (0, __TURBOPACK__imported__module__$5b$project$5d2f$types$2f$supabase$2d$joins$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["resolveJoin"])(r.memberships);
            return {
                id: r.id,
                date: r.date,
                employeeName: membership?.display_name || null,
...
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerServerReference"])(getSalesReportAction, "705cf0da7b5e9845b1d65d4cf79b38ea2b9d2963b2", null);
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerServerReference"])(getCashRegisterReportAction, "40878cd0ad1bdc5adbcebb35ed0494afa56ccb52ce", null);
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerServerReference"])(getStockReportAction, "40ce712cd546b72610d5dbdcd104688d7aff60a476", null);
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerServerReference"])(getExpiringProductsReportAction, "60fdd35c71699cd623fa6469c2c8ced0d7fc735b42", null);
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerServerReference"])(getCashRegistersListAction, "704bd179d789321c61f1ffc814274d3ee114d8014c", null);
}),
"[project]/lib/logging.ts [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const LOG_CONFIG = {
    ...
    minLevel: ("TURBOPACK compile-time falsy", 0) ? "TURBOPACK unreachable" : "debug",
...
async function captureToSentry(entry) {
...
function createErrorResponse(errorCode, userMessage, internalError, meta) {
    // Log interno con detalles técnicos
    if (internalError) {
        logger.error("action", userMessage, internalError, {
            errorCode,
            ...meta
        });
    }
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$logging$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/logging.ts [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$action$2d$validate$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/build/webpack/loaders/next-flight-loader/action-validate.js [app-rsc] (ecmascript)");
;
;
;
 ...
 */ async function generateMissions(cashRegisterId, userId, organizationId, branchId) {
    try {
        ...
        if (missionsToInsert.length > 0) {
            ...
            if (insertError) {
                __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$logging$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["logger"].error('generateMissions', 'Error insertando misiones', insertError, {
                    cashRegisterId,
                    userId,
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$logging$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["logger"].error('generateMissions', 'Error generando misiones', error instanceof Error ? error : new Error(String(error)), {
            cashRegisterId,
            userId,
            organizationId,
            branchId
...
async function cerrarCajaAction(cajaId, montoDeclarado) {
    try {
        const { supabase, user } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$actions$2f$auth$2d$helpers$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["verifyAuth"])();
...
async function createMissionAction(params) {
    try {
        const { supabase, orgId: organizationId } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$actions$2f$auth$2d$helpers$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["verifyOwner"])();
...
async function getStockSummary(productoIds, organizationId, sucursalId) {
    ...
    try {
        const supabase = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2d$server$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["createClient"])();
        const { data, error } = await supabase.from('stock_batches').select('product_id, quantity').eq('organization_id', organizationId).eq('branch_id', sucursalId).eq('status', 'available').in('product_id', productoIds);
        if (error) {
...
async function processComplexStockEntry(params) {
    try {
        const { supabase, user, orgId: organizationId } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$actions$2f$auth$2d$helpers$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["verifyAuth"])();
...
async function getCapitalSummaryAction(_organizationId) {
    try {
        const { supabase, orgId: organizationId } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$actions$2f$auth$2d$helpers$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["verifyAuth"])();
...
async function processServiceRechargeAction(data) {
    try {
        ...
        // ───────────────────────────────────────────────────────────────────────────
        const { data: turno, error: turnoError } = await supabase.from('cash_registers').select('organization_id').eq('id', data.turnoId).single();
        if (turnoError || !turno) {
            return {
                success: false,
        ...
        const { error: cajaError } = await supabase.from('cash_movements').insert({
            organization_id: turno.organization_id,
...
async function confirmSaleAction(params) {
    try {
        ...
        if (error) {
            __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$logging$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["logger"].error('confirmSaleAction', 'Error procesando venta', error, {
    ...
    try {
        ...
        return {
            ...
            sale: {
                ...
                items: (items || []).map((i)=>({
                        id: i.id,
                        product_name: (0, __TURBOPACK__imported__module__$5b$project$5d2f$types$2f$supabase$2d$joins$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["resolveJoin"])(i.products)?.name || 'Producto',
                        quantity: i.quantity,
...
"[project]/.next-internal/server/app/page/actions.js { ACTIONS_MODULE0 => \"[project]/lib/actions/dashboard.actions.ts [app-rsc] (ecmascript)\", ACTIONS_MODULE1 => \"[project]/lib/actions/user.actions.ts [app-rsc] (ecmascript)\", ACTIONS_MODULE2 => \"[project]/lib/actions/attendance.actions.ts [app-rsc] (ecmascript)\", ACTIONS_MODULE3 => \"[project]/lib/actions/auth.actions.ts [app-rsc] (ecmascript)\", ACTIONS_MODULE4 => \"[project]/lib/actions/branch.actions.ts [app-rsc] (ecmascript)\", ACTIONS_MODULE5 => \"[project]/lib/actions/product.actions.ts [app-rsc] (ecmascript)\", ACTIONS_MODULE6 => \"[project]/lib/actions/provider.actions.ts [app-rsc] (ecmascript)\", ACTIONS_MODULE7 => \"[project]/lib/actions/reports.actions.ts [app-rsc] (ecmascript)\", ACTIONS_MODULE8 => \"[project]/lib/actions/cash.actions.ts [app-rsc] (ecmascript)\", ACTIONS_MODULE9 => \"[project]/lib/actions/missions.actions.ts [app-rsc] (ecmascript)\", ACTIONS_MODULE10 => \"[project]/lib/actions/inventory.actions.ts [app-rsc] (ecmascript)\", ACTIONS_MODULE11 => \"[project]/lib/actions/service.actions.ts [app-rsc] (ecmascript)\", ACTIONS_MODULE12 => \"[project]/lib/actions/ventas.actions.ts [app-rsc] (ecmascript)\" } [app-rsc] (server actions loader, ecmascript) <locals>", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$actions$2f$reports$2e$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/actions/reports.actions.ts [app-rsc] (ecmascript)");
...
"[project]/.next-internal/server/app/page/actions.js { ACTIONS_MODULE0 => \"[project]/lib/actions/dashboard.actions.ts [app-rsc] (ecmascript)\", ACTIONS_MODULE1 => \"[project]/lib/actions/user.actions.ts [app-rsc] (ecmascript)\", ACTIONS_MODULE2 => \"[project]/lib/actions/attendance.actions.ts [app-rsc] (ecmascript)\", ACTIONS_MODULE3 => \"[project]/lib/actions/auth.actions.ts [app-rsc] (ecmascript)\", ACTIONS_MODULE4 => \"[project]/lib/actions/branch.actions.ts [app-rsc] (ecmascript)\", ACTIONS_MODULE5 => \"[project]/lib/actions/product.actions.ts [app-rsc] (ecmascript)\", ACTIONS_MODULE6 => \"[project]/lib/actions/provider.actions.ts [app-rsc] (ecmascript)\", ACTIONS_MODULE7 => \"[project]/lib/actions/reports.actions.ts [app-rsc] (ecmascript)\", ACTIONS_MODULE8 => \"[project]/lib/actions/cash.actions.ts [app-rsc] (ecmascript)\", ACTIONS_MODULE9 => \"[project]/lib/actions/missions.actions.ts [app-rsc] (ecmascript)\", ACTIONS_MODULE10 => \"[project]/lib/actions/inventory.actions.ts [app-rsc] (ecmascript)\", ACTIONS_MODULE11 => \"[project]/lib/actions/service.actions.ts [app-rsc] (ecmascript)\", ACTIONS_MODULE12 => \"[project]/lib/actions/ventas.actions.ts [app-rsc] (ecmascript)\" } [app-rsc] (server actions loader, ecmascript)", ((__turbopack_context__) => {
"use strict";
...
__turbopack_context__.s([
    ...
    "40878cd0ad1bdc5adbcebb35ed0494afa56ccb52ce",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$actions$2f$reports$2e$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getCashRegisterReportAction"],
    ...
    "40ce712cd546b72610d5dbdcd104688d7aff60a476",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$actions$2f$reports$2e$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getStockReportAction"],
    ...
    "40f9514d7f3e486894a69a1ee200cf46d4b6cfc67e",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$actions$2f$dashboard$2e$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getQuickSnapshotAction"],
    ...
    "60fdd35c71699cd623fa6469c2c8ced0d7fc735b42",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$actions$2f$reports$2e$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getExpiringProductsReportAction"],
    ...
    "704bd179d789321c61f1ffc814274d3ee114d8014c",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$actions$2f$reports$2e$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getCashRegistersListAction"],
    "70566edb59723eff9936c2369e9dad493a944a2a2d",
    ...
    "705cf0da7b5e9845b1d65d4cf79b38ea2b9d2963b2",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$actions$2f$reports$2e$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getSalesReportAction"],
    ...
    "78fefa28db228ef2be5fad91633ef642e7e4cad836",
...
var __TURBOPACK__imported__module__$5b$project$5d2f2e$next$2d$internal$2f$server$2f$app$2f$page$2f$actions$2e$js__$7b$__ACTIONS_MODULE0__$3d3e$__$225b$project$5d2f$lib$2f$actions$2f$dashboard$2e$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29222c$__ACTIONS_MODULE1__$3d3e$__$225b$project$5d2f$lib$2f$actions$2f$user$2e$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29222c$__ACTIONS_MODULE2__$3d3e$__$225b$project$5d2f$lib$2f$actions$2f$attendance$2e$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29222c$__ACTIONS_MODULE3__$3d3e$__$225b$project$5d2f$lib$2f$actions$2f$auth$2e$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29222c$__ACTIONS_MODULE4__$3d3e$__$225b$project$5d2f$lib$2f$actions$2f$branch$2e$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29222c$__ACTIONS_MODULE5__$3d3e$__$225b$project$5d2f$lib$2f$actions$2f$product$2e$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29222c$__ACTIONS_MODULE6__$3d3e$__$225b$project$5d2f$lib$2f$actions$2f$provider$2e$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29222c$__ACTIONS_MODULE7__$3d3e$__$225b$project$5d2f$lib$2f$actions$2f$reports$2e$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29222c$__ACTIONS_MODULE8__$3d3e$__$225b$project$5d2f$lib$2f$actions$2f$cash$2e$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29222c$__ACTIONS_MODULE9__$3d3e$__$225b$project$5d2f$lib$2f$actions$2f$missions$2e$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29222c$__ACTIONS_MODULE10__$3d3e$__$225b$project$5d2f$lib$2f$actions$2f$inventory$2e$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29222c$__ACTIONS_MODULE11__$3d3e$__$225b$project$5d2f$lib$2f$actions$2f$service$2e$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29222c$__ACTIONS_MODULE12__$3d3e$__$225b$project$5d2f$lib$2f$actions$2f$ventas$2e$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$2922$__$7d$__$5b$app$2d$rsc$5d$__$28$server__actions__loader$2c$__ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i('[project]/.next-internal/server/app/page/actions.js { ACTIONS_MODULE0 => "[project]/lib/actions/dashboard.actions.ts [app-rsc] (ecmascript)", ACTIONS_MODULE1 => "[project]/lib/actions/user.actions.ts [app-rsc] (ecmascript)", ACTIONS_MODULE2 => "[project]/lib/actions/attendance.actions.ts [app-rsc] (ecmascript)", ACTIONS_MODULE3 => "[project]/lib/actions/auth.actions.ts [app-rsc] (ecmascript)", ACTIONS_MODULE4 => "[project]/lib/actions/branch.actions.ts [app-rsc] (ecmascript)", ACTIONS_MODULE5 => "[project]/lib/actions/product.actions.ts [app-rsc] (ecmascript)", ACTIONS_MODULE6 => "[project]/lib/actions/provider.actions.ts [app-rsc] (ecmascript)", ACTIONS_MODULE7 => "[project]/lib/actions/reports.actions.ts [app-rsc] (ecmascript)", ACTIONS_MODULE8 => "[project]/lib/actions/cash.actions.ts [app-rsc] (ecmascript)", ACTIONS_MODULE9 => "[project]/lib/actions/missions.actions.ts [app-rsc] (ecmascript)", ACTIONS_MODULE10 => "[project]/lib/actions/inventory.actions.ts [app-rsc] (ecmascript)", ACTIONS_MODULE11 => "[project]/lib/actions/service.actions.ts [app-rsc] (ecmascript)", ACTIONS_MODULE12 => "[project]/lib/actions/ventas.actions.ts [app-rsc] (ecmascript)" } [app-rsc] (server actions loader, ecmascript) <locals>');
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$actions$2f$dashboard$2e$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/actions/dashboard.actions.ts [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$actions$2f$user$2e$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/actions/user.actions.ts [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$actions$2f$attendance$2e$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/actions/attendance.actions.ts [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$actions$2f$auth$2e$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/actions/auth.actions.ts [app-rsc] (ecmascript)");
...
//# sourceMappingURL=_ef38da0f._.js.map