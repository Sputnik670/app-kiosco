...
"[project]/lib/services/pdf-generator.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/lib/services/excel-generator.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/lib/offline/sync-manager.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
class SyncManager {
   ...
   */ async syncAll() {
        ...
        try {
            ...
            const ventasPendientes = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$offline$2f$indexed$2d$db$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["offlineDB"].getVentasParaSincronizar();
   ...
   */ async retryFailed() {
        ...
        for (const venta of ventasConError){
            ...
            await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$offline$2f$indexed$2d$db$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["offlineDB"].put('ventas-pendientes', {
                ...venta,
                estado: 'pending',
                intentos: 0,
                ultimo_error: null
   ...
   */ async getStats() {
        const todas = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$offline$2f$indexed$2d$db$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["offlineDB"].getVentasPendientes();
        return {
...
//# sourceMappingURL=lib_3253a3cc._.js.map